...
function changeSelectBoxYear()
{
	...
	var before20year = Math.round(currentyear.getFullYear()-24);
	
	//alert("startYear:"+startYear+" < "+before20year);
	
	if(startYear<before20year){
